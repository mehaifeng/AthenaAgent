...
```bash
$CLI apply-template --input source.docx --template template.docx --output out.docx --mode base-replace \
  --start-marker "[[ATHENA_BODY_START]]" --end-marker "[[ATHENA_BODY_END]]"
```
