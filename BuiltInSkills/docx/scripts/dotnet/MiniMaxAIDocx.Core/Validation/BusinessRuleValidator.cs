...
public class BusinessRuleValidator
{
    ...
    private void ValidateRelationships(ZipArchive zip, XDocument doc, ValidationResult result)
    {
        ...
        // Do not flag every defined-but-unreferenced ID as orphaned here. Several required
        // Word parts (styles, settings, theme, numbering, and similar package-level parts)
        // are reached implicitly through document.xml.rels and have no r:id attribute in
        // document.xml. Missing relationships referenced by document markup remain errors.
    }
