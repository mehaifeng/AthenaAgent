...
public static class ListAndNumberingSamples
{
        ...
        StyleDefinitionsPart stylesPart)
    {
        ...
        var numbering = EnsureNumberingRoot(numPart);
        ...
        NumberingDefinitionsPart numPart, Body body)
    {
        ...
        EnsureNumberingRoot(numPart).Append(restartedInstance);
        ...
        NumberingDefinitionsPart numPart, int abstractNumId, Level[] levels)
    {
        ...
        NumberingInstance? firstNumInstance =
            numbering.GetFirstChild<NumberingInstance>();
    ...
    /// </summary>
    private static Numbering EnsureNumberingRoot(NumberingDefinitionsPart numPart) =>
