...
public static class ExtensionProviderCatalog
{
    ...
    [
        ...
        new("xAI", "xAI Web Search", "https://api.x.ai/v1", "grok-4-fast"),
    ...
    [
        ...
        new("OpenAI", "OpenAI", "https://api.openai.com/v1", "gpt-image-1"),
        new("OpenAICodex", "OpenAI Codex Auth", "https://chatgpt.com/backend-api", "gpt-5"),
        new("OpenRouter", "OpenRouter", "https://openrouter.ai/api/v1", "google/gemini-2.5-flash-image-preview"),
        new("xAI", "xAI", "https://api.x.ai/v1", "grok-2-image-1212")
    ];

    public static IReadOnlyList<ExtensionProviderOption> AudioProviders { get; } =
    [
        new("Edge", "Microsoft Edge TTS", "", "", "en-US-AriaNeural"),
        new("OpenAI", "OpenAI", "https://api.openai.com/v1/audio/speech", "gpt-4o-mini-tts", "alloy"),
        new("xAI", "xAI", "https://api.x.ai/v1/tts", "tts-1", "eve"),
        ...
        new("Gemini", "Google Gemini TTS", "https://generativelanguage.googleapis.com/v1beta", "gemini-2.5-flash-preview-tts", "Kore"),
