...
public partial class App : Application, IAsyncDisposable
{
    ...
    private static void ConfigureServices(IServiceCollection services)
    {
        ...
        services.AddSingleton<Athena.UI.Services.Presentations.PptxPackageService>();
        services.AddSingleton<PresentationFunctions>(sp =>
            new PresentationFunctions(
                sp.GetRequiredService<IFileSystemService>(),
                sp.GetRequiredService<Athena.UI.Services.Presentations.PptxPackageService>(),
                Log.ForContext<PresentationFunctions>()));
        ...
        services.AddSingleton<IFunctionRegistry>(sp =>
        {
            ...
            var presentationFunctions = sp.GetRequiredService<PresentationFunctions>();
            var configService = sp.GetService<IConfigService>();
